...
-- CreateEnum
CREATE TYPE "PowerLevel" AS ENUM ('HIGH', 'MEDIUM', 'LOW');

-- CreateEnum
CREATE TYPE "InfluenceRole" AS ENUM ('DECISION_MAKER', 'INFLUENCER', 'GATEKEEPER', 'END_USER', 'UNKNOWN');

-- CreateEnum
CREATE TYPE "PoliticalStance" AS ENUM ('CHAMPION', 'SUPPORTIVE', 'NEUTRAL', 'SKEPTIC', 'HOSTILE', 'UNKNOWN');

-- CreateEnum
CREATE TYPE "LegacyStakeholderRelationship" AS ENUM ('BOSS', 'PEER', 'DIRECT_REPORT', 'SKIP_LEVEL', 'BOARD_MEMBER', 'INVESTOR', 'CUSTOMER', 'VENDOR', 'EXTERNAL');
...
-- CreateEnum
CREATE TYPE "OrgRelation" AS ENUM ('EMPLOYER', 'CLIENT', 'VENDOR', 'PARTNER', 'COMPETITOR', 'INVESTOR', 'REGULATOR', 'OTHER');

-- CreateEnum
CREATE TYPE "EntityType" AS ENUM ('USER', 'STAKEHOLDER', 'ORGANIZATION', 'TEAM');

-- CreateEnum
CREATE TYPE "ValueType" AS ENUM ('TRUST_DEPOSIT', 'INFLUENCE_WITHDRAWAL', 'INFORMATION_EXCHANGE', 'SOCIAL_CAPITAL');

-- CreateEnum
CREATE TYPE "ObjOwnerType" AS ENUM ('USER', 'ORGANIZATION', 'TEAM');

-- CreateEnum
CREATE TYPE "ObjStatus" AS ENUM ('ACTIVE', 'BLOCKED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "ObjPriority" AS ENUM ('HIGH', 'MEDIUM', 'LOW');

-- CreateEnum
CREATE TYPE "DependencyType" AS ENUM ('BLOCKER', 'SPONSOR', 'CONTRIBUTOR', 'DECISION_MAKER', 'RISK');
...
CREATE TABLE "StakeholderProfile" (
    ...
    "orgId" TEXT,
    "teamId" TEXT,
    "powerLevel" "PowerLevel" NOT NULL DEFAULT 'LOW',
    "influenceRole" "InfluenceRole" NOT NULL DEFAULT 'UNKNOWN',
    "politicalStance" "PoliticalStance" NOT NULL DEFAULT 'UNKNOWN',
    "archetype" TEXT,
...
CREATE TABLE "Organization" (
    ...
    "domain" TEXT,
    "industry" TEXT,
    "relationToUser" "OrgRelation" NOT NULL,
    "size" TEXT,
    "metadata" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ProfessionalTeam" (
    ...
    CONSTRAINT "ProfessionalTeam_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "RelationshipValue" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "RelationshipValue_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "StrategicObjective" (
    ...
    "ownerType" "ObjOwnerType" NOT NULL,
    "projectId" TEXT,
    "title" TEXT NOT NULL,
    "description" TEXT,
    "status" "ObjStatus" NOT NULL DEFAULT 'ACTIVE',
    "priority" "ObjPriority" NOT NULL DEFAULT 'MEDIUM',
...
-- CreateIndex
CREATE INDEX "StakeholderRelationship_fromEntityId_idx" ON "StakeholderRelationship"("fromEntityId");

-- CreateIndex
CREATE INDEX "StakeholderRelationship_toEntityId_idx" ON "StakeholderRelationship"("toEntityId");
...
-- AddForeignKey
ALTER TABLE "StakeholderProfile" ADD CONSTRAINT "StakeholderProfile_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StakeholderProfile" ADD CONSTRAINT "StakeholderProfile_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES "ProfessionalTeam"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ProfessionalTeam" ADD CONSTRAINT "ProfessionalTeam_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProfessionalTeam" ADD CONSTRAINT "ProfessionalTeam_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProfessionalProject" ADD CONSTRAINT "ProfessionalProject_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProfessionalProject" ADD CONSTRAINT "ProfessionalProject_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organization"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StakeholderRelationship" ADD CONSTRAINT "StakeholderRelationship_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RelationshipValue" ADD CONSTRAINT "RelationshipValue_relationshipId_fkey" FOREIGN KEY ("relationshipId") REFERENCES "StakeholderRelationship"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StrategicObjective" ADD CONSTRAINT "StrategicObjective_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StrategicObjective" ADD CONSTRAINT "StrategicObjective_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "ProfessionalProject"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ObjectiveDependency" ADD CONSTRAINT "ObjectiveDependency_objectiveId_fkey" FOREIGN KEY ("objectiveId") REFERENCES "StrategicObjective"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ObjectiveDependency" ADD CONSTRAINT "ObjectiveDependency_stakeholderId_fkey" FOREIGN KEY ("stakeholderId") REFERENCES "StakeholderProfile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
